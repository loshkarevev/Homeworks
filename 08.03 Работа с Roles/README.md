...
```root@vagrant:/home/Homeworks/08.03 Работа с Roles# ansible-galaxy install -r requirements.yml --roles-path ./
- extracting java to /home/Homeworks/08.03 Работа с Roles/old_playbook/java
- java (1.0.1) was installed successfully
```
Тест
```
root@vagrant:/home/Homeworks/08.03 Работа с Roles/old_playbook/java# molecule test
...
```
root@vagrant:/home/Homeworks/08.03 Работа с Roles/elastic-role# molecule init scenario -d docker
INFO     Initializing new scenario default...
INFO     Initialized scenario in /home/Homeworks/08.03 Работа с Roles/elastic-role/molecule/default successfully.
```
#### 4. Добавьте несколько разных дистрибутивов (centos:8, ubuntu:latest) для инстансов и протестируйте роль, исправьте найденные ошибки, если они есть
```
root@vagrant:/home/Homeworks/08.03 Работа с Roles/elastic-role# molecule test
INFO     default scenario test matrix: dependency, lint, cleanup, destroy, syntax, create, prepare, converge, idempotence, side_effect, verify, cleanup, destroy
INFO     Performing prerun...
...
```
root@vagrant:/home/Homeworks/08.03 Работа с Roles# molecule init role -d docker 08_kibana-role
INFO     Initializing new role 08_kibana-role...
Using /etc/ansible/ansible.cfg as config file
- Role 08_kibana-role was created successfully
INFO     Initialized role in /home/Homeworks/08.03 Работа с Roles/08_kibana-role successfully.
```
Тестирование роли
```
root@vagrant:/home/Homeworks/08.03 Работа с Roles/08_kibana-role# molecule test
INFO     default scenario test matrix: dependency, lint, cleanup, destroy, syntax, create, prepare, converge, idempotence, side_effect, verify, cleanup, destroy
INFO     Performing prerun...
...
changed: [localhost] => (item={'started': 1, 'finished': 0, 'ansible_job_id': '914470095185.89836', 'results_file': '/home/root/.ansible_async/914470095185.89836', 'changed': True, 'failed': False, 'item': {'image': 'docker.io/pycontribs/centos:8', 'name': 'centos8', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'started': 1, 'finished': 0, 'ansible_job_id': '48492610635.89861', 'results_file': '/home/root/.ansible_async/48492610635.89861', 'changed': True, 'failed': False, 'item': {'image': 'docker.io/pycontribs/centos:7', 'name': 'centos7', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'started': 1, 'finished': 0, 'ansible_job_id': '604199252717.89886', 'results_file': '/home/root/.ansible_async/604199252717.89886', 'changed': True, 'failed': False, 'item': {'image': 'docker.io/pycontribs/ubuntu:latest', 'name': 'ubuntu', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
...
#### 9. 
```
root@vagrant:/home/Homeworks/08.03 Работа с Roles/08_playbook# ansible-playbook -i inventory/prod.yml site.yml
